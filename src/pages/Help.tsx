...
export const Help = () => {
  ...
  const faqs = [
    {
      q: 'বাংলাদেশ সার্ভিস ডিরেক্টরি কী?',
      a: 'বাংলাদেশ সার্ভিস ডিরেক্টরি হলো বাংলাদেশ সরকারের বিভিন্ন বিভাগ ও মন্ত্রণালয়ের সেবা অনুসন্ধানের একটি স্বাধীন গেটওয়ে বা নির্দেশিকা (Directory Portal)। এটি সকল সরকারি সেবাকে এক জায়গায় সংগঠিত করে নাগরিকদের সরাসরি সঠিক ও ভেরিফায়েড অফিশিয়াল সরকারি ওয়েবসাইটে পৌঁছে দেয়।'
    },
    {
      q: 'বাংলাদেশ সার্ভিস ডিরেক্টরি কি নিজে কোনো সরকারি সেবা প্রদান করে?',
      a: 'না। বাংলাদেশ সার্ভিস ডিরেক্টরি কোনো সরকারি সেবা প্রদান বা আবেদন প্রক্রিয়া পরিচালনা করে না। আমরা নাগরিকদের শুধুমাত্র সঠিক সরকারি ওয়েবসাইটে পৌঁছে দেওয়ার মাধ্যম হিসেবে কাজ করি।'
    },
    {
    ...
    },
    {
      ...
      a: 'বাংলাদেশ সার্ভিস ডিরেক্টরিতে প্রতিটি সেবার নামের পাশে "✓ Official" বা "Verified Link" ব্যাজ দেখতে পাবেন। এছাড়া সরকারি ওয়েবসাইটগুলোর ডোমেইনের শেষে সবসময় .gov.bd থাকে।'
    },
    {
    ...
    },
    {
      ...
      a: 'হ্যাঁ! বাংলাদেশ সার্ভিস ডিরেক্টরি একটি ১০০% ফ্রি নাগরিক সেবা নির্দেশিকা।'
    }
  ];
        ...
        <div className="bg-[#004D3A] text-white py-12 px-4 border-b-4 border-[#F42A41]">
          <div className="max-w-4xl mx-auto text-center space-y-3">
            ...
            <p className="text-xs sm:text-sm text-emerald-100 max-w-xl mx-auto">
              বাংলাদেশ সার্ভিস ডিরেক্টরি ব্যবহারের নির্দেশিকা এবং বহুল জিজ্ঞাসিত প্রশ্নগুলোর উত্তর নিচে দেওয়া হলো।
            </p>
          </div>
        </div>
